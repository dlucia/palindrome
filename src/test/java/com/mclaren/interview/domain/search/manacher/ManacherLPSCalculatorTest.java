...
public class ManacherLPSCalculatorTest
{
  ...
  {
    assertThat(lpsCalculator.lpsArrayFrom(new String[] { SEPARATOR, "a", SEPARATOR, "b", SEPARATOR }),
               is(new int[] { 0, 1, 0, 1, 0 }));

    assertThat(lpsCalculator.lpsArrayFrom(new String[] { SEPARATOR, "c", SEPARATOR, "d", SEPARATOR, "e",
  ...
  public void singleLongPalindrome()
  {
    ...
    assertThat(lpsCalculator.lpsArrayFrom(new String[] { SEPARATOR, "a", SEPARATOR, "b", SEPARATOR, "c",
                   SEPARATOR, "d", SEPARATOR, "e", SEPARATOR, "e", SEPARATOR, "d", SEPARATOR, "c",
                   SEPARATOR, "b", SEPARATOR, "a", SEPARATOR }),
  ...
  public void manyLongPalindrome()
  {
    ...
    assertThat(lpsCalculator.lpsArrayFrom(new String[] { SEPARATOR, "a", SEPARATOR, "b", SEPARATOR, "c",
                   SEPARATOR, "a", SEPARATOR, "c", SEPARATOR, "b", SEPARATOR, "b", SEPARATOR, "b",
                   SEPARATOR, "c", SEPARATOR, "a", SEPARATOR }),
